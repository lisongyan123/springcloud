...
import static com.example.java8.streamex.Internals.checkLength;
...
public class EntryStream<K, V> extends AbstractStreamEx<Entry<K, V>, EntryStream<K, V>> {
    ...
    @Override
    EntryStream<K, V> supply(Stream<Entry<K, V>> stream) {
     ...
     *
     * <p>
     * This method is unlikely to work on {@code EntryStream}, because {@link Entry} instances rarely implement
